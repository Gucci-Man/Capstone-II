 ...
 * recipeModel.js
 * --------------
 * Manages interaction with the 'recipes' database table. Provides methods to:
 *
 * *  Retrieve recipes generated by ChatGPT and add them to the database.
 * *  Fetch, update, and delete saved recipes.
 * *  Filter recipes based on the associated user (creator).
 * 
 * Dependencies:
 * *  db (from db.js): Provides database connection.
 * *  callChatGPT (from chatGPTAPI.js): Communicates with ChatGPT to generate recipes.
